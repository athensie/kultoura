...
<header class="navbar navbar-solid">
    ...
    <nav class="nav-links">
        ...
        <div class="dropdown">
            ...
            <div class="mega-menu">
                <div class="mega-column">
                    ...
                    <a href="tourism/restaurants.php">Restaurants</a>
                </div>
                <div class="mega-column">
        ...
        <a href="about.php" class="nav-item nav-active"><span class="nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 11.5v5"/><circle cx="12" cy="7.8" r="0.9" fill="currentColor" stroke="none"/></svg></span><span>ABOUT</span></a>
    </nav>
...
<footer class="a-footer">
    ...
    <p class="a-footer-tag">Promoting culture yes. Preserving heritage. Inspiring journeys.</p>
</footer>
