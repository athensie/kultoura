...
analytics_track($conn, 'resort');

$resortHeroPhoto = sitecontent_get_photo($conn, 'resort_hero');

// Logged for foryou.php's "Because You Explored" recommendations.
$_SESSION['history'][] = 'resort';
...
$stmt = $conn->prepare(
    "SELECT d.*,
     ...
     FROM destination d
     WHERE d.category = 'resort' AND d.status = 'active'
...
<head>
    ...
    <title>Resort – KULTOURA</title>
    <link rel="stylesheet" href="../../assets/css/index.css">
    <link rel="stylesheet" href="../../assets/css/tourism.css">
    <link rel="stylesheet" href="../../assets/css/resort.css">
</head>
<body>
...
<!-- ── Page Hero ── -->
<section class="t-hero<?php echo $resortHeroPhoto ? ' t-hero-has-photo' : ''; ?>">
    <?php if ($resortHeroPhoto): ?>
        <img class="t-hero-photo" src="<?php echo htmlspecialchars($resortHeroPhoto); ?>" alt="">
    ...
    <div class="t-hero-inner">
        ...
        <h1 class="t-page-title">Resorts</h1>
        <p class="t-page-sub">
            Poolside relaxation and weekend getaways — Malvar's best leisure destinations.
        </p>
    </div>
</section>
    ...
    <section class="t-category" id="resort">
        <div class="t-category-header">
            <div>
                ...
                <h2 class="t-cat-title">Resorts</h2>
                <p class="t-cat-desc">Places to relax and unwind around Malvar, from day tours to overnight stays.</p>
            </div>
        </div>

        <?php if (empty($resorts)): ?>
        <div class="p-empty-state">
            <h3>No resorts added yet</h3>
...
function ktOpenViewDetails(btn) {
    ktTrackItemView('resort', btn.dataset.id);
